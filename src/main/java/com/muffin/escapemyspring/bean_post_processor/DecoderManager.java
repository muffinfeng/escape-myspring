...
public class DecoderManager implements BeanPostProcessor{
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if(videoTypeIndex.containsKey(type)){
            throw new IllegalStateException("重复注入");
        }
        log.info("postProcessBefore has sign {} for videoType : {}", decoder.getClass(), type);
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        log.info("postProcessAfter has run {}", bean.getClass());
        return null;
    }
}
